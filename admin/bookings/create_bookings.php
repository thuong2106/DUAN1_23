            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <form id="quickForm" method="POST" action="create_bookings.php">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_account" class="form-control" id="name_account" placeholder="Nhập tên khách hàng">
                                        </div>
                                        <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary ml-2" onclick="addFields()">Thêm phòng </button>
                        ...
                        <select class="form-control" name="room_id[]">
                          ...
                          if (isset($list_rooms) && is_array($list_rooms)) {
                            foreach ($list_rooms as $index => $rooms): ?>
                              <option value="<?php echo $rooms['id'] ?>"><?php echo $rooms['room_name'] ?></option>
                            <?php endforeach;
                          } else {
