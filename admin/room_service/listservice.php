                                    ...
                                    foreach ($list_service as $index => $service) : ?>
                                        <tr style="text-align:center;">
                                            ...
                                            <td class="project-actions text-right">
                                                <a class="btn btn-info btn-sm" href="update_service.php?action=update&update_service=<?= $service['id'] ?>">
                                                    <i class="fas fa-pencil-alt">
                                                    </i>&nbsp;
                                                    Edit
                                                </a>
                                                <a href="listservice.php?action=delete&delete_service_id=<?= $service['id'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>&nbsp;Delete</a>
                                            </td>
                                        </tr>
                                <?php endforeach;
                                } else {
